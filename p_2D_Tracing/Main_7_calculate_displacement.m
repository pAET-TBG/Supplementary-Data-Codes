...
load('atom_model_sim_exp_matched_2D_Tracing.mat')
...
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Parameter setting
convXflag = 1;   % if true the x-axis will be convolve
convYflag = 1;   % if true the y=axis will be convolve
convZflag = 1;   % if true the z-axis will be convolve
...
view(90,30);
hold off;
save([pwd,'/output_data/atom_model_upper_layer_displacement_1_convolution_2D_Tracing.mat'],'atomup_sim','displacementUP','labelup')
