...
for iter = 1:21
    ...
    elseif iter == 21
        ...
        atom(1,:) = atompos(1,:)-10;
        atom(2,:) = atompos(2,:)-10;
        save([pwd,'/output_data/atom_tracing_model_Lower_Layer.mat'],'Slice','atom');
    else  
...
load('atom_tracing_model_Lower_Layer.mat')
load('manual_atom_Lower_Layer.mat')
