...
projections = importdata('Projs_Refinement_sim_2D_Tracing.mat');
angles      = importdata('angles_Refinement_sim_2D_Tracing.mat');
model       = importdata('atom_Refinement_sim_2D_Tracing.mat');
model_org   = importdata('atom_Refinement_sim_2D_Tracing.mat');
atoms       = importdata('label_Refinement_sim_2D_Tracing.mat');
...
save([pwd,'/output_data/atom_tracing_model_refinement_total_2D_Tracing.mat'],'model')
