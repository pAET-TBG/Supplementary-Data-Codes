function [atom_exp,atom_sim] = atom_align_exp_sim_model_2(atom_exp,atom_sim)
for iteration = 1:2
    ...
    for iter = 1:2
        ...
        if iteration == 1 && iter == 1
            thetaVector = -0.01:0.001:0.01;
        else
            thetaVector = -0.005:0.001:0.005;
        end
        ...
        ratioVector = 0.9995:0.0001:1.0005;
