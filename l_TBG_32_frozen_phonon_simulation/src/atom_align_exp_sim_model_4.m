function [atom_exp,atom_sim] = atom_align_exp_sim_model_4(atom_exp,atom_sim)
for iteration = 1:2
    ...
    for iter = 1:2
        ...
        if iteration == 1 && iter == 1
            thetaVector = -0.0001:0.00001:0.0001;
        else
            thetaVector = -0.00005:0.00001:0.00005;
        end
        ...
        ratioVector = 0.999995:0.000001:1.000005;
    ...
    while true
        ...
        thetax = -0.00005:0.000005:0.00005;
        ...
        thetay = -0.00005:0.000005:0.00005;
