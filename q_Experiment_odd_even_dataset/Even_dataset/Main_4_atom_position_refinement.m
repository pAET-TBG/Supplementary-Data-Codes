...
projections = importdata('Projs_Refinement_Even.mat');
angles      = importdata('angles_Refinement_Even.mat');
model       = importdata('atom_Refinement_Even.mat');
model_org   = importdata('atom_Refinement_Even.mat');
atoms       = importdata('label_Refinement_Even.mat');
...
save([pwd,'/output_data/atom_tracing_model_refinement_total_Even.mat'],'model')

%% crop the refinement result and calculate the manual tracing ratio
clear;clc
atom        = importdata('atom_tracing_model_refinement_total_Even.mat');
label       = importdata('label_Refinement_Even.mat');
...
atom = atom.*Res;
save([pwd,'/output_data/atom_tracing_model_refinement_Even.mat'],'atom','label');
