...
projections = importdata('Projs_Refinement_Tot.mat');
angles      = importdata('angles_Refinement_Tot.mat');
model       = importdata('atom_Refinement_Tot.mat');
model_org   = importdata('atom_Refinement_Tot.mat');
atoms       = importdata('label_Refinement_Tot.mat');
...
save([pwd,'/output_data/atom_tracing_model_refinement_total_Even_Tot.mat'],'model')

%% crop the refinement result and calculate the manual tracing ratio
clear;clc
atom        = importdata('atom_tracing_model_refinement_total_Even_Tot.mat');
label       = importdata('label_Refinement_Tot.mat');
...
atom = atom.*Res;
save([pwd,'/output_data/atom_tracing_model_refinement_Even_Tot.mat'],'atom','label');
