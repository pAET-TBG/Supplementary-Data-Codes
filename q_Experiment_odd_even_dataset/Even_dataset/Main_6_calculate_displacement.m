...
load('atom_model_sim_exp_matched_Even.mat')
...
figure(1)
quiver3(atomup_sim(1,:), atomup_sim(2,:), atomup_sim(3,:), displacementUP(1,:).*50, displacementUP(2,:).*50, displacementUP(3,:).*250 ,'Color', 'b', 'LineWidth', 1, 'MaxHeadSize', 4);
axis equal;
view(90,30);
hold off;
save([pwd,'/output_data/atom_model_upper_layer_displacement_1_convolution_Even.mat'],'atomup_sim','displacementUP')

%% calculate the displacement and display the vector in lower layer
displacementDOWN = atomdown - atomdown_sim;
figure(2)
quiver3(atomdown_sim(1,:), atomdown_sim(2,:), atomdown_sim(3,:), displacementDOWN(1,:).*50, displacementDOWN(2,:).*50, displacementDOWN(3,:).*250 ,'Color', 'r', 'LineWidth', 1, 'MaxHeadSize', 4);
axis equal;
view(90,30);
hold off;
save([pwd,'/output_data/atom_model_lower_layer_displacement_1_Convolution_Even.mat'],'atomdown_sim','displacementDOWN')
