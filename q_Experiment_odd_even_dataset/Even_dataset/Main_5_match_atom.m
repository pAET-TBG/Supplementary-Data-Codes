...
load('atom_tracing_model_refinement_Even.mat')
Res = 0.19/2;                    
...
save([pwd,'/output_data/atom_model_sim_exp_matched_Even.mat'],'atomup','atomup_sim','labelup','atomupgroup','atomdown','atomdown_sim','labeldown','atomdowngroup')
