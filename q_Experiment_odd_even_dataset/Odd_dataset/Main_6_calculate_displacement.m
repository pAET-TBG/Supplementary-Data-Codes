...
load('atom_model_sim_exp_matched_Odd.mat')
...
view(90,30);
hold off;
save([pwd,'/output_data/atom_model_upper_layer_displacement_1_convolution_Odd.mat'],'atomup_sim','displacementUP')
...
view(90,30);
hold off;
save([pwd,'/output_data/atom_model_lower_layer_displacement_1_convolution_Odd.mat'],'atomdown_sim','displacementDOWN')
