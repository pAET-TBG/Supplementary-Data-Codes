...
save([pwd,'/output_data/atom_tracing_model_refinement_total_Odd_Tot.mat'],'model')

%% crop the refinement result and calculate the manual tracing ratio
clear;clc
atom        = importdata('atom_tracing_model_refinement_total_Odd_Tot.mat');
...
atom = atom.*Res;
save([pwd,'/output_data/atom_tracing_model_refinement_Odd_Tot.mat'],'atom','label');
