...
load('atom_tracing_model_refinement_Odd.mat')
Res = 0.19/2;                    
...
save([pwd,'/output_data/atom_model_sim_exp_matched_Odd.mat'],'atomup','atomup_sim','labelup','atomupgroup','atomdown','atomdown_sim','labeldown','atomdowngroup')
