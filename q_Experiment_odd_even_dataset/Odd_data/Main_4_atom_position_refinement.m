...
projections = importdata('Projs_Refinement_Odd.mat');
angles      = importdata('angles_Refinement_Odd.mat');
model       = importdata('atom_Refinement_Odd.mat');
model_org   = importdata('atom_Refinement_Odd.mat');
atoms       = importdata('label_Refinement_Odd.mat');
...
save([pwd,'/output_data/atom_tracing_model_refinement_total_Odd.mat'],'model')

%% crop the refinement result and calculate the manual tracing ratio
clear;clc
atom        = importdata('atom_tracing_model_refinement_total_Odd.mat');
label       = importdata('label_Refinement_Odd.mat');
...
atom = atom.*Res;
save([pwd,'/output_data/atom_tracing_model_refinement_Odd.mat'],'atom','label');
