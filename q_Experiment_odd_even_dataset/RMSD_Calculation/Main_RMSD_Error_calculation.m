...
histogram(disarr12.*100,40,'FaceColor',[0 0.4470 0.7410],'EdgeColor', 'k','LineWidth',5/1.5,'BinWidth', 1.155/2*3/45*50);hold on;
xlim([0  50]);ylim([0 800]);                                               % Set the x-axis limits from 0 to 50
xticks(0:25:50);yticks(0:200:800);
