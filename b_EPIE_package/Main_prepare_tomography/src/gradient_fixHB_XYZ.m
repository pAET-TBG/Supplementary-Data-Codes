...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% grad_x = zeros(num_atom,1,'single');
% grad_y = zeros(num_atom,1,'single');
% grad_z = zeros(num_atom,1,'single');
% momentum = 0.9;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%        
%         grad_x(k) = grad_x(k).*momentum + dt*grad_x_k;
%         grad_y(k) = grad_y(k).*momentum + dt*grad_y_k;
%         grad_z(k) = grad_z(k).*momentum + dt*grad_z_k;
%         X(k) = X(k) - grad_x(k);
%         Y(k) = Y(k) - grad_y(k);
%         Z(k) = Z(k) - grad_z(k);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
