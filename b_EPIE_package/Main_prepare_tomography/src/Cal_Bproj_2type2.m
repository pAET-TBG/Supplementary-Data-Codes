...
% tic
% for i=1:num_pj
%     figure(11);imagesc(ydata(:,:,i))
%     hold on;
%     scatter(Y_rot(i,:)+round(size(ydata,2)/2),X_rot(i,:)+round(size(ydata,1)/2),'r.');
%     hold off;
%     drawnow
% end
for i=1:num_pj
...
% for i=1:num_pj
%     figure(12);
%     subplot(1,2,1);imagesc(Projs(:,:,i))
%     subplot(1,2,2);imagesc(ydata(:,:,i))
%     drawnow
% end
...
% for i=1:num_pj
%     figure(11);
%     subplot(1,3,1);imagesc(Projs(:,:,i));
%     subplot(1,3,2);imagesc(ydata(:,:,i));
%     subplot(1,3,3);imagesc(ydata(:,:,i)-Projs(:,:,i));
%     drawnow;
% end

% figure(11);img(Projs,[],ydata,[],Projs-ydata,[],'colormap','gray')
