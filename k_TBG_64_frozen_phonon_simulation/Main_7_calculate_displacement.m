...
for idx = 1:2
    ...
    if idx == 1
        subplot(1,2,1)
        quiver3(atomup_sim(1,:), atomup_sim(2,:), atomup_sim(3,:), displacementUP(1,:).*15, displacementUP(2,:).*15, displacementUP(3,:).*15,0 ,'Color', 'b', 'LineWidth', 1, 'MaxHeadSize', 4,'AutoScale', 'off');hold on
        axis equal off;
        view(0,90);
        xlim([-3500 3500])
        ylim([-5500 5500])
    ...
    if idx == 1
        subplot(1,2,1)
        quiver3(atomdown_sim(1,:), atomdown_sim(2,:), atomdown_sim(3,:), displacementDOWN(1,:).*15, displacementDOWN(2,:).*15, displacementDOWN(3,:).*15,0 ,'Color', 'r', 'LineWidth', 1, 'MaxHeadSize', 4,'AutoScale', 'off');
        axis equal off;
        view(0,90);
        xlim([-3500 3500])
        ylim([-5500 5500])
