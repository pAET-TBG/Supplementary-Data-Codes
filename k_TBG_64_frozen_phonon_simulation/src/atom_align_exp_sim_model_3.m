function [atom_exp,atom_sim] = atom_align_exp_sim_model_3(atom_exp,atom_sim)
for iteration = 1:2
    ...
    for iter = 1:2
        ...
        if iteration == 1 && iter == 1
            thetaVector = -0.001:0.0001:0.001;
        else
            thetaVector = -0.0005:0.0001:0.0005;
        end
        ...
        ratioVector = 0.99995:0.00001:1.00005;
