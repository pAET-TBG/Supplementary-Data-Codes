function [atom_exp,atom_sim] = atom_align_exp_sim_model_5(atom_exp,atom_sim)
for iteration = 1:2
    ...
    for iter = 1:2
        ...
        if iteration == 1 && iter == 1
            thetaVector = -0.00001:0.000001:0.00001;
        else
            thetaVector = -0.000005:0.000001:0.000005;
        end
        ...
        ratioVector = 0.9999995:0.0000001:1.0000005;
    ...
    while true
        ...
        thetax = -0.000005:0.0000005:0.000005;
        ...
        thetay = -0.000005:0.0000005:0.000005;
